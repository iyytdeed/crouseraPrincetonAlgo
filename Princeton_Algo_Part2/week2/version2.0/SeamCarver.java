...
public class SeamCarver {
    ...
    public int[] findHorizontalSeam(){
        ...
        while(true){
            ...
            if(row+1<height-1){
                if(dist+picEnergyMatrix[row+1][col+1]<distTo[row+1][col+1]){
            ...
            if(dist+picEnergyMatrix[row][col+1]<distTo[row][col+1]){
    ...
    public int[] findVerticalSeam(){
        if(height<=2 || width <= 2){
            ...
            for(int i=0;i<height;i++) res[i] = 0;
            return res;
        }
        // step_1 intial var
        MinPQ<Edge> minPQ = new MinPQ<Edge>();
        ...
        while(true){
            ...
            if(dist+picEnergyMatrix[row+1][col]<distTo[row+1][col]){
    ...
    public void removeHorizontalSeam(int[] seam){
        ...
        if(seam[0]<0 || seam[0]>height-1) throw new java.lang.IllegalArgumentException();
    ...
    public void removeVerticalSeam(int[] seam){
        ...
        if(seam[0]<0 || seam[0]>width-1) throw new java.lang.IllegalArgumentException();
        for(int i=1;i<seam.length;i++){
